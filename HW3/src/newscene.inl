...
void Scene::init(void){
    ...
    geometry["cube2"] = new Cube;
    geometry["cube3"] = new Cube;
    geometry["cube4"] = new Cube;
    geometry["cube5"] = new Cube;
    geometry["cube6"] = new Cube;
    ...
    model["cube2"]->geometry = geometry["cube2"];
    model["cube2"]->material = material["ceramic"];
    model["cube3"] = new Model;
    model["cube3"]->geometry = geometry["cube3"];
    model["cube3"]->material = material["wood"];
    model["cube4"] = new Model;
    model["cube4"]->geometry = geometry["cube4"];
    model["cube4"]->material = material["silver"];
    model["cube5"] = new Model;
    model["cube5"]->geometry = geometry["cube5"];
    model["cube5"]->material = material["ceramic"];
    model["cube6"] = new Model;
    model["cube6"]->geometry = geometry["cube6"];
    model["cube6"]->material = material["silver"];
    ...
    node["pyramid"]->models.push_back(model["cube2"]);
    node["pyramid"]->modeltransforms.push_back(translate(vec3(0.5f, 2.0f, 0.0f))* scale(vec3(0.1f)));
    node["pyramid"]->models.push_back(model["cube3"]);
    node["pyramid"]->modeltransforms.push_back(translate(vec3(-0.5f, 2.0f, 0.0f))* scale(vec3(0.1f)));
    node["pyramid"]->models.push_back(model["cube4"]);
    node["pyramid"]->modeltransforms.push_back(translate(vec3(0.25f, 2.5f, 0.0f))* scale(vec3(0.1f)));
    node["pyramid"]->models.push_back(model["cube5"]);
    node["pyramid"]->modeltransforms.push_back(translate(vec3(-0.25f, 2.5f, 0.0f))* scale(vec3(0.1f)));
    node["pyramid"]->models.push_back(model["cube6"]);
    node["pyramid"]->modeltransforms.push_back(translate(vec3(0.0f, 3.0f, 0.0f))* scale(vec3(0.1f)));
    ...
    node["bunny2"]->modeltransforms.push_back(scale(vec3(0.8f))* translate(vec3(0.0f, 1.0f, 0.0f)));
    
    node["world"] -> childnodes.push_back( node["table"] );
    node["world"] -> childtransforms.push_back( mat4(1.0f) );
    node["world"] -> childnodes.push_back( node["bunny"] );
    node["world"] -> childtransforms.push_back( translate(vec3(-2.0f,0.5f,0.0f)) * rotate( 135.0f*float(M_PI)/180.0f, vec3(0.0f, 1.0f, 0.0f) ));
    node["world"]->childnodes.push_back(node["bunny2"]);
    node["world"]->childtransforms.push_back(translate(vec3(2.0f, 0.5f, 0.0f))* rotate(-45.0f * float(M_PI) / 180.0f, vec3(0.0f, 1.0f, 0.0f)));
    node["world"]->childnodes.push_back(node["pyramid"]);
    node["world"]->childtransforms.push_back(scale(vec3(1.0f)));
